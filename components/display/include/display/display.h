...
void task_ssd1306_scroll(void *ignore) {
  ...
  i2c_master_write_byte(cmd, 0x29,
                        true); // vertical and horizontal scroll (p29)
...
void display_clear(void) {
  xTaskCreate(&task_ssd1306_display_clear, "ssd1306_display_clear", 2048, NULL,
              6, NULL);
}
...
void display_init(void) {
  if (!displayInitialized) {
    ...
    dsp_wait_wifi();
    // xTaskCreate(&task_ssd1306_display_pattern, "ssd1306_display_pattern",
    // 2048, NULL, 6, NULL); xTaskCreate(&task_ssd1306_contrast,
    // "ssid1306_contrast", 2048, NULL, 6, NULL);
    // xTaskCreate(&task_ssd1306_scroll, "ssid1306_scroll", 2048, NULL, 6,
    // NULL);
    displayInitialized = true;
  }
}